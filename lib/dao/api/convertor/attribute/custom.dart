...
class CustomAttributeConvertor extends AttributeConvertor<CustomAttribute, Object> {
  ...
  @override
  Future<Object?> to(CustomAttribute? value, {Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
  ...
  @override
  Future<CustomAttribute?> from(Object? value, {CustomAttribute? attribute, Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
...
class CustomListAttributeConvertor extends AttributeConvertor<CustomListAttribute, List<Object>> {
  ...
  @override
  Future<List<Object>?> to(CustomListAttribute? value, {Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
    if (null == value) return null;
  ...
  @override
  Future<CustomListAttribute?> from(Object? value, {CustomListAttribute? attribute, Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
    if (null == attribute) return attribute;
    attribute.clear();
