...
class DateTimeAttributeConvertor extends AttributeConvertor<DateTimeAttribute, int> {
  ...
  @override
  Future<int?> to(DateTimeAttribute? value, {Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
  ...
  @override
  Future<DateTimeAttribute?> from(Object? value, {DateTimeAttribute? attribute, Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
...
class DateTimeListAttributeConvertor extends AttributeConvertor<DateTimeListAttribute, List<int>> {
  ...
  @override
  Future<List<int>?> to(DateTimeListAttribute? value, {Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
  ...
  @override
  Future<DateTimeListAttribute?> from(Object? value, {DateTimeListAttribute? attribute, Transaction? tx, bool? isLogicDelete, bool? isCache}) async {
    if (null == attribute) return attribute;
    attribute.clear();
    if (null == value) return attribute;
